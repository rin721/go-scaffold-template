...
`oapi-codegen.yaml` 固定 strict Chi 生成选项。`internal/tools/openapi-inventory` 在生成前校验 operation identity 与策略完整性，并从同一规范生成低基数 inventory，供 Router、授权、日志、trace、metrics 和测试复用。
