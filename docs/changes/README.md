...
- [022 HTTP API 脚手架成熟就绪度](022-http-api-template-readiness/README.md)：生命周期与统一 diagnostics P0 已实施并验证，整体仍为 Foundation-partial；配置确定性、完整 Foundation acceptance，以及 API 契约、安全、管理、遥测、交付和 release 仍待后续独立计划。
