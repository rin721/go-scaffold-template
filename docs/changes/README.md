...
- [027 第三方封装与分轨装配](027-business-module-third-party-isolation/README.md)：研究与纯文档设计已完成，非文档实施待确认；新增业务能力先完整收口到模块，专属第三方留在模块 Adapter 并零泄漏，只有跨业务复用且由进程统一选择的资源才进入完整底层链。
