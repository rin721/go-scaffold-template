...
import (
	...
	httpbinding "github.com/rin721/go-scaffold2/internal/business/todo/binding/http"
	modelbinding "github.com/rin721/go-scaffold2/internal/business/todo/binding/model"
...
const moduleID business.ModuleID = "todo"
...
func New(dependencies Dependencies) (Module, error) {
	...
	if err := business.ValidateContributions(contribution); err != nil {
